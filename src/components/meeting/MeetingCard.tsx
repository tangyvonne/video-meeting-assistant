...
export function MeetingCard({ id, title, date, startTime, endTime, duration, host, attendees, link, platform, status, isSample, _count, onDelete }: MeetingCardProps) {
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            {isSample && (
              <Badge className="bg-amber-100 text-amber-600 text-xs">示例</Badge>
            )}
